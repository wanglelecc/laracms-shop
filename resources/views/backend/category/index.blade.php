        ...
        <div class="col-md-12">
            ...
            <div class="table-tools" style="margin-bottom: 15px;">
                ...
                <div class="tools-group">
                    <a href="{{ route('administrator.shop.category.create', [0]) }}"  class="btn btn-primary"><i class="icon icon-plus-sign"></i> 添加</a>
                    <button class="btn btn-danger" form="form-category-list"><i class="icon icon-sort-by-order-alt"></i> 排序</button>
                </div>
            </div>

            @if(count($categorys))
                <form name="form-article-list" id="form-category-list" class="layui-form layui-form-pane2" method="POST" action="{{route('administrator.category.order')}}">
