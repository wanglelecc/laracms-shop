...
use Wanglelecc\Laracms\Shop\Http\Middleware;

class LaracmsShopServiceProvider extends ServiceProvider
{
...
//        ],
    ...
    public function boot(){
        ...
        $this->loadViewsFrom( __DIR__.'/../../resources/views/backend', 'backend.shop' );
        $this->loadViewsFrom( __DIR__.'/../../resources/views/frontend/', 'frontend.shop' );
    }
